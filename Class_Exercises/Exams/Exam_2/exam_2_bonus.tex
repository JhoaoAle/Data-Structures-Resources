...
Debe corregir el archivo de manera que se comporte de acuerdo con lo esperado. Es decir, debe tomar un conjunto finito de valores enteros, almacenarlos en un montículo tipo \textit{minHeap}, y posteriormente insertar dichos valores, en ese orden, dentro de un árbol AVL, sobre el cual se realizará un recorrido inOrder.
